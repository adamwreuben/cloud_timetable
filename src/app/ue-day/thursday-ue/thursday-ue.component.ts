...
@Component({
  selector: 'app-thursday-ue',
  templateUrl: './thursday-ue.component.html',
  styleUrls: ['./thursday-ue.component.css']
})
export class ThursdayUeComponent implements OnInit, DoCheck {
              ...
              userVerificationType.forEach((resultsTypes) => {
                ...
                if (this.adminType === 'collaborate') {
                  this.firebaseService.getTimetableUe(this.statuService.universityNameService,
                    this.statuService.courseNameService, this.statuService.weekSelected, 'Thursday')
                  .subscribe(thursday => {
                  ...
                  this.firebaseService.getUniversityCourse(datauser.uid).subscribe(datas => {
                    if (datas.length !== 0){
                      ...
                      datas.forEach(results => {
                        ...
                        this.firebaseService.getTimetableUe(this.university, this.course, this.statuService.weekSelected, 'Thursday')
                        .subscribe(thursday => {
